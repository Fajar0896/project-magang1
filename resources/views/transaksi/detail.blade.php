...
<ul class="list-group">
  ...
  <li class="list-group-item">Nama Sales : {{$payment->nama_sales }}</li>
  <li class="list-group-item">Tipe Barang : {{$payment->tipe->tipe }}</li>
  <li class="list-group-item">Tanggal Bayar : {{$payment->tgl_bayar }}</li>
  <li class="list-group-item">Total Bayar : {{$payment->total_bayar }}</li>
  <li class="list-group-item">Kode Pembayaran : {{$payment->kode_pembayaran }}</li>
